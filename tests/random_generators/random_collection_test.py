...
def test_random_collection():
    ...
    random_value_distribution = get_random_values_distribution(VALUES, WEIGHTS, 10_000)
...
def test_random_collection_gets_randomized():
    ...
    random_distribution = get_random_values_distribution(VALUES, WEIGHTS, 10_000, 1)
    random_distribution_randomized = get_random_values_distribution(VALUES, WEIGHTS, 10_000, 1000)
